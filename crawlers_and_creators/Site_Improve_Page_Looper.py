...
class Site_Improve_Page_Looper:
    ...
    def collect_pages(self,
                      command,
                      output_file="/home/tim/Documents/Modeling-and-Data-Analysis-in-Complex-Networks/final/logs/Site_Improve_Page_Looper_" + time.asctime(time.localtime(time.time())).replace(
                          ' ', '_') + "_output.json",
                      error_output_file="/home/tim/Documents/Modeling-and-Data-Analysis-in-Complex-Networks/final/logs/Site_Improve_Page_Looper_" + time.asctime(
                          time.localtime(time.time())).replace(' ', '_') + "_error_output.json",
                      error_log_file="/home/tim/Documents/Modeling-and-Data-Analysis-in-Complex-Networks/final/logs/Site_Improve_Page_Looper_" + time.asctime(
